...
SELECT COUNT(1) FROM waggle.student_activity_progress_data WHERE CreatedDate >'2023-09-04' AND IsPublished=1 ORDER BY  CreatedDate DESC ;
SELECT COUNT(1) FROM waggle.student_activity_progress_data WHERE CreatedDate >'2023-08-31' AND IsPublished=0 ORDER BY  CreatedDate DESC  ;
...
SELECT  COUNT(DISTINCT StudentRefId) TotalStudents  FROM waggle.student_activity_progress_data WHERE IsPublished=0 ORDER BY  CreatedDate DESC ;
...
SELECT * FROM waggle.student_activity_progress_data WHERE CreatedDate >'2023-09-01' AND IsPublished=0 ORDER BY  CreatedDate DESC LIMIT 1 ;
